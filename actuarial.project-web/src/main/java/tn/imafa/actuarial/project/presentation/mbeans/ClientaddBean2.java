...
//System.out.println(countryList);
        ...
        latestclients=service.findAllClientstridate().subList(0,2);
...
*/
	...
	public Client getClientajoute() {
		return clientajoute;
	}



	public void setClientajoute(Client clientajoute) {
		this.clientajoute = clientajoute;
	}
